...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_20px_hsl(84_81%_44%/0.3)]",
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_hsl(84_81%_44%/0.3)] hover:shadow-[0_0_30px_hsl(84_81%_44%/0.5)] hover:scale-105 px-8",
        glass: "bg-card/50 backdrop-blur-xl border border-border/50 text-foreground hover:border-primary/50 hover:shadow-[0_0_30px_hsl(84_81%_44%/0.15)]",
      },
      size: {
